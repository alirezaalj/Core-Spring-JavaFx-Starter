package ir.alirezaalijani.javafx.application.ui.util;
...
public class ViewPath {
    ...
    public static final URL QU_ANSER_ALERT = getUrl("view","alert","alertQuAnser.fxml");
    ...
    public static URL ViewMarketOverview=getUrl("view","MarketOverviewView.fxml");
    public static URL ViewProducts = getUrl("view","Products.fxml");
    public static URL ViewImportXlsx = getUrl("view","DataImportXlsx.fxml");
    public static URL ViewImportCustom = getUrl("view","DataImportCustom.fxml");
    public static URL ViewOrderListOverview= getUrl("view","OrdersListOverview.fxml");
