package ir.alirezaalijani.javafx.application.ui.util.alert;

import ir.alirezaalijani.javafx.application.ui.util.alert.alertController.QuAlertAnserController;
import ir.alirezaalijani.javafx.application.ui.util.alert.alertController.QuAlertController;
import ir.alirezaalijani.javafx.application.ui.util.ViewPath;
...
public class QuAlert {
    ...
    public QuAlertResponse showQu(String title,String message){
        ...
        try{
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(ViewPath.QU_ANSER_ALERT);
            loader.load();
            Parent root = loader.getRoot();
            Stage stage = new Stage();
            controller=loader.getController();
